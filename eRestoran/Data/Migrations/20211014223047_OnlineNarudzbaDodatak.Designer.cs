...
namespace eRestoran.Data.Migrations
{
    ...
    [Migration("20211014223047_OnlineNarudzbaDodatak")]
    partial class OnlineNarudzbaDodatak
    {
            ...
            modelBuilder.Entity("eRestoran.Models.OnlineNarudzba", b =>
                {
                    ...
                    b.Property<string>("IzdavateljRačunaID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eRestoran.Models.OnlineNarudzba", b =>
                {
                    ...
                    b.HasOne("eRestoran.Models.OnlineGost", "IzdavateljRačuna")
                        .WithMany()
                        .HasForeignKey("IzdavateljRačunaID");
